...
Do not duplicate items, this includes dragon eggs, sand, and concrete (which are able to be farmed on this server through other means). TNT entity duplication is specifically _allowed_.
