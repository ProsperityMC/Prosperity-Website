...
As a member of Prosperity you are expectedt to abide by these rules. The size of our community permits that we handle infractions on a case-by-case basis, but this also means that there is no chance for you to get away with loopholes or repeatedly getting away with causing trouble.
...
2. **Perform due-dillegence in following player instructions.** Including documentation, in-game signage and books, and other messaging. If you are unsure how to use a machine or farm and break it, that's on you.
